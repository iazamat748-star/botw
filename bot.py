...
def handle_all(message):
    ...
    try:
        ...
        if message.content_type == 'photo':
            ...
            caption = message.caption if message.caption else "Салалар бойынша талдап бер."
        ...
        if response:
            ...
            if "```" in response.text:
                ...
                if files:
                    bot.send_message(chat_id, "📦 Файл дайындалды, жіберіп жатырмын...")
                    ...
                    for filename in files:
                        try:
                            ...
                            bot.send_message(chat_id, f"Файлды жіберу қатесі: {e}")
...
if __name__ == "__main__":
    print("🤖 UNIVERSAL BOT (Server Ready) іске қосылды!")
