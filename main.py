...
# ТҮЗЕТІЛДІ: os.getenv ішіне кілттің МӘНІН емес, АТЫН жазу керек.
# Render-дегі "Environment Variables" бөліміндегі атпен бірдей болуы шарт.
...
model = genai.GenerativeModel(
    model_name='gemini-2.5-pro', # pro-ға қарағанда flash жылдам әрі тұрақты
...
@app.get("/")
def home():
    return {"status": "Bot is running on Render (Port 4000)!"}
...
# ТҮЗЕТІЛДІ: Порт 4000-ға ауыстырылды
if __name__ == "__main__":
    import uvicorn
    # host="0.0.0.0" сырттан қосылуға рұқсат береді
